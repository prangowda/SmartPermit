...
public class UpdatePermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_status = findViewById(R.id.upp_status);
    }

    public void btn_upcaz(View view) {
        _chackValidation();
    }
    ...
    private void _sendData() {
        ...
        Call<DefaultModal> modalCall = apiInterface.getUpdatePermissionResponse(status, uid,getIntent().getStringExtra("permissionNumber"));
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().getSuccess()) {
                                ...
                                Toast.makeText(UpdatePermissionActivity.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                            } else {
    ...
    private void showAlertDialog(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdatePermissionActivity.this);

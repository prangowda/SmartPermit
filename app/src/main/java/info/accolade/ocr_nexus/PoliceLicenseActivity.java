...
public class PoliceLicenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_police_license);
        ...
        sp_status = findViewById(R.id.uplp_status);
    }

    public void policec2(View view) {
        _chackValidation();
    }
    ...
    private void _sendData() {
        ...
        Call<DefaultModal> modalCall = apiInterface.getUpdatePoliceLicenseResponse(status, uid, getIntent().getStringExtra("licenseNumber"));
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().getSuccess()) {
                                ...
                                Toast.makeText(PoliceLicenseActivity.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                            } else {
    ...
    private void showAlertDialog(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(PoliceLicenseActivity.this);

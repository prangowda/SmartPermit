...
public class UpdateRenewalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_renewal);
        ...
        sp_status = findViewById(R.id.upr_status);
        ed_exp = findViewById(R.id.expdate2);
        ...
        ed_exp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(UpdateRenewalActivity.this, date, myCalendar
    ...
    public void btn_upccc(View view) {
        _chackValidation();
    }
    ...
    private void _sendData() {
        ...
        Call<DefaultModal> modalCall = apiInterface.getUpdateRenewResponse(status, uid, getIntent().getStringExtra("licenseNumber"), exp);
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().getSuccess()) {
                                ...
                                Toast.makeText(UpdateRenewalActivity.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                            } else {
    ...
    private void showAlertDialog(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateRenewalActivity.this);

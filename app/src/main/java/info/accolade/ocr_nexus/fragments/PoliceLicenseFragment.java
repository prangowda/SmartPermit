...
import info.accolade.ocr_nexus.PoliceLicenseActivity;
 ...
 * Use the {@link PoliceLicenseFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PoliceLicenseFragment extends Fragment {
     ...
     * @return A new instance of fragment PoliceLicenseFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PoliceLicenseFragment newInstance(String param1, String param2) {
        PoliceLicenseFragment fragment = new PoliceLicenseFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_police_license, container, false);

        recyclerView = root.findViewById(R.id.policeLicenseRecycle);
    ...
    private void _loadData() {
        ...
        Call<List<LicenseModal>> artModal = apiInterface.getPoliceLicenseResponse();
                        ...
                        if (response.body() != null) {
                            ...
                            listener = new LicenseAdapter.RecyclerViewClickListener() {
                                ...
                                public void onClick(View v, int position) {
                                    Intent i = new Intent(getContext(), PoliceLicenseActivity.class);

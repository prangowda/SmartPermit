...
import info.accolade.ocr_nexus.PoliceRenewActivity;
 ...
 * Use the {@link PoliceRenewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PoliceRenewFragment extends Fragment {
     ...
     * @return A new instance of fragment PoliceRenewFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PoliceRenewFragment newInstance(String param1, String param2) {
        PoliceRenewFragment fragment = new PoliceRenewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_police_renew, container, false);

        recyclerView = root.findViewById(R.id.policeRenewRecycle);
    ...
    private void _loadData() {
        ...
        Call<List<RenewModal>> artModal = apiInterface.getPoliceRenewResponse();
                        ...
                        if (response.body() != null) {
                            ...
                            listener = new RenewAdapter.RecyclerViewClickListener() {
                                ...
                                public void onClick(View v, int position) {
                                    Intent i = new Intent(getContext(), PoliceRenewActivity.class);

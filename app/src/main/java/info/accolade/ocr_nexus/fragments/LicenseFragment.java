...
public class LicenseFragment extends Fragment {
    ...
    String status, name, number, address, trade;
    Spinner sp_status;
    Button complaint_submit;
    EditText ed_name, ed_number, ed_address, ed_trade;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        click = view.findViewById(R.id.viewlicense);
        click.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment selectedFragment = new ViewUserLicenseFragment();
        ...
        sp_status = view.findViewById(R.id.litype);

        complaint_submit = view.findViewById(R.id.licence_submit);
        ed_address = view.findViewById(R.id.licence_holder_address);
        ed_name = view.findViewById(R.id.licence_holder_name);
        ed_number = view.findViewById(R.id.li_holder_contact);
        ed_trade = view.findViewById(R.id.trade_address);
    ...
    private void _sendData() {
        ...
        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<DefaultModal> modalCall = apiInterface.getAddLicenseResponse(uid,status, name, number, address, trade);

...
import info.accolade.ocr_nexus.UpdateComplaintActivity;
 ...
 * Use the {@link ViewMunicipalComplaintsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ViewMunicipalComplaintsFragment extends Fragment {
    ...
    public ViewMunicipalComplaintsFragment() {
     ...
     * @return A new instance of fragment ViewMunicipalComplaintsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ViewMunicipalComplaintsFragment newInstance(String param1, String param2) {
        ViewMunicipalComplaintsFragment fragment = new ViewMunicipalComplaintsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_view_municipal_complaints, container, false);
        recyclerView = root.findViewById(R.id.municipalcomplaintsRecycle);
    ...
    private void _loadData() {
        ...
        Call<List<ComplaintsModal>> artModal = apiInterface.getMunicipalComplaintsResponse();
                        ...
                        if (response.body() != null) {
                            ...
                            listener = new ComplaintAdapter.RecyclerViewClickListener() {
                                ...
                                public void onClick(View v, int position) {
                                    Intent i = new Intent(getContext(), UpdateComplaintActivity.class);
                                    i.putExtra("complaintNumber", modals.get(position).getNumber());
                                    startActivity(i);
                                }
                            };

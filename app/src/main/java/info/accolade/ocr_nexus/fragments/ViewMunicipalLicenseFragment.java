 ...
 * Use the {@link ViewMunicipalLicenseFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ViewMunicipalLicenseFragment extends Fragment {
    ...
    public ViewMunicipalLicenseFragment() {
     ...
     * @return A new instance of fragment ViewMunicipalLicenseFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ViewMunicipalLicenseFragment newInstance(String param1, String param2) {
        ViewMunicipalLicenseFragment fragment = new ViewMunicipalLicenseFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_view_municipal_license, container, false);

        recyclerView = root.findViewById(R.id.municipalLicenseRecycle);
    ...
    private void _loadData() {
        ...
        Call<List<LicenseModal>> artModal = apiInterface.getMunicipalLicenseResponse();
                        ...
                        if (response.body() != null) {
                            ...
                            listener = new LicenseAdapter.RecyclerViewClickListener() {
                                ...
                                public void onClick(View v, int position) {
                                    Intent i = new Intent(getContext(), UpdateLicenseActivity.class);

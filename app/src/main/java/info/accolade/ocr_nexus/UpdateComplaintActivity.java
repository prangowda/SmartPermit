...
public class UpdateComplaintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_status = findViewById(R.id.upc_status);
    }

    public void btn_upca(View view) {
        _chackValidation();
    }
    ...
    private void _sendData() {
        ...
        Call<DefaultModal> modalCall = apiInterface.getUpdateComplaintResponse(status, uid, getIntent().getStringExtra("complaintNumber"));
                    ...
                    if(response.isSuccessful())
                    {
                        if(response.body()!=null)
                        {
                            if(response.body().getSuccess())
                            {
                                ...
                                Toast.makeText(UpdateComplaintActivity.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                            }
                            else
                            {
    ...
    private void showAlertDialog(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateComplaintActivity.this);

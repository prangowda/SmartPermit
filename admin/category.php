<?php
  ...
  <div class="main-content">
    <div class="container-fluid content-top-gap">
        ...
        <div></div>
          <h3>Manage License Category <a href="add-category.php"><span class="float-right text-primary"><i class="fa fa-plus"></i> Add Category</span></a></h3>
        </div>
        <div class="card card_border p-lg-5 p-3 mb-4">
          <div class="card-body py-3 p-0">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display table-hover" width="100%">
                                ...
                                <?php 
                                    $query=mysqli_query($conn,"select * from category where status = true order by id desc");
                                    $cnt=1;
